<script setup lang="ts">
  ...
  import DotSeparator from '@/app/components/AppDotSeparator.vue'
  import PlayerProgressBar from '@/app/modules/player/components/atoms/PlayerProgressBar.vue'
  import IconLike from '@/app/components/AppIconLike.vue'
  ...
  import PlayerRemoteListeningDevice from '@/app/modules/player/components/atoms/PlayerRemoteListeningDevice.vue'
